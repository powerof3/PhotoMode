...
namespace ENB_API
{
	...
	public:
		...
		/// </summary>
		void SetCallbackFunction(ENBCallbackFunction a_func) const
		{
		...
		bool GetParameter(char* a_filename, char* a_category, char* a_keyname, ENBParameter* a_outparam) const
		{
		...
		bool GetParameter(const char* a_filename, const char* a_category, const char* a_keyname, ENBParameter* a_outparam) const
		{
		...
		/// </returns>
		bool SetParameter(char* a_filename, char* a_category, char* a_keyname, ENBParameter* a_inparam) const
		{
		...
		bool SetParameter(const char* a_filename, const char* a_category, const char* a_keyname, ENBParameter* a_inparam) const
		{
	...
	public:
		...
		/// </returns>
		ENBRenderInfo* GetRenderInfo() const
		{
		...
		/// </returns>
		long GetState(ENBStateType state) const
		{
	...
	public:
		...
		using _TwGetBarName = const char* (*)(const TwBar* bar);
		using _TwGetBarByIndex = TwBar* (*)(int barIndex);
		using _TwGetBarByName = TwBar* (*)(const char* barName);
		using _TwRefreshBar = int (*)(TwBar* bar);

		TwBar* TwNewBar(const char* barName) const
		{
			return reinterpret_cast<_TwNewBar>(GetProcAddress(enbmodule, "TwNewBar"))(barName);
		}

		int TwDeleteBar(TwBar* bar) const
		{
			return reinterpret_cast<_TwDeleteBar>(GetProcAddress(enbmodule, "TwDeleteBar"))(bar);
		}

		TwBar* TwGetBarByIndex(int barIndex) const
		{
			return reinterpret_cast<_TwGetBarByIndex>(GetProcAddress(enbmodule, "TwGetBarByIndex"))(barIndex);
		}

		TwBar* TwGetBarByEnum(ENBWindowType barIndex) const
		{
			return reinterpret_cast<_TwGetBarByIndex>(GetProcAddress(enbmodule, "TwGetBarByIndex"))(static_cast<int>(barIndex));
		}

		TwBar* TwGetBarByName(const char* barName) const
		{
			return reinterpret_cast<_TwGetBarByName>(GetProcAddress(enbmodule, "TwGetBarByName"))(barName);
		}

		int TwRefreshBar(TwBar* bar) const
		{
			return reinterpret_cast<_TwRefreshBar>(GetProcAddress(enbmodule, "TwRefreshBar"))(bar);
		}

		using _TwAddVarRW = int (*)(TwBar* bar, const char* name, TwType type, void* var, const char* def);
		using _TwAddVarRO = int (*)(TwBar* bar, const char* name, TwType type, const void* var, const char* def);
		using _TwAddVarCB = int (*)(TwBar* bar, const char* name, TwType type, TwSetVarCallback setCallback, TwGetVarCallback getCallback, void* clientData, const char* def);
		using _TwAddButton = int (*)(TwBar* bar, const char* name, TwButtonCallback callback, void* clientData, const char* def);
		using _TwAddSeparator = int (*)(TwBar* bar, const char* name, const char* def);
		using _TwRemoveVar = int (*)(TwBar* bar, const char* name);
		using _TwRemoveAllVars = int (*)(TwBar* bar);

		int TwAddVarRW(TwBar* bar, const char* name, TwType type, void* var, const char* def) const
		{
			return reinterpret_cast<_TwAddVarRW>(GetProcAddress(enbmodule, "TwAddVarRW"))(bar, name, type, var, def);
		}

		int TwAddVarRO(TwBar* bar, const char* name, TwType type, const void* var, const char* def) const
		{
			return reinterpret_cast<_TwAddVarRO>(GetProcAddress(enbmodule, "TwAddVarRO"))(bar, name, type, var, def);
		}

		int TwAddVarCB(TwBar* bar, const char* name, TwType type, TwSetVarCallback setCallback, TwGetVarCallback getCallback, void* clientData, const char* def) const
		{
		...
		int TwAddButton(TwBar* bar, const char* name, TwButtonCallback callback, void* clientData, const char* def) const
		{
			return reinterpret_cast<_TwAddButton>(GetProcAddress(enbmodule, "TwAddButton"))(bar, name, callback, clientData, def);
		}

		int TwAddSeparator(TwBar* bar, const char* name, const char* def) const
		{
			return reinterpret_cast<_TwAddSeparator>(GetProcAddress(enbmodule, "TwAddVarRO"))(bar, name, def);
		}

		int TwRemoveVar(TwBar* bar, const char* name) const
		{
			return reinterpret_cast<_TwRemoveVar>(GetProcAddress(enbmodule, "TwRemoveVar"))(bar, name);
		}

		int TwRemoveAllVars(TwBar* bar) const
		{
			return reinterpret_cast<_TwRemoveAllVars>(GetProcAddress(enbmodule, "TwRemoveAllVars"))(bar);
		}

		using _TwGetParam = int (*)(TwBar* bar, const char* varName, const char* paramName, TwParamValueType paramValueType, unsigned int outValueMaxCount, void* outValues);
		using _TwSetParam = int (*)(TwBar* bar, const char* varName, const char* paramName, TwParamValueType paramValueType, unsigned int inValueCount, const void* inValues);

		int TwGetParam(TwBar* bar, const char* varName, const char* paramName, TwParamValueType paramValueType, unsigned int outValueMaxCount, void* outValues) const
		{
		...
		int TwSetParam(TwBar* bar, const char* varName, const char* paramName, TwParamValueType paramValueType, unsigned int inValueCount, const void* inValues) const
		{
	...
	[[nodiscard]] static inline void* RequestENBAPI(const SDKVersion a_ENBSDKVersion = SDKVersion::V1001)
	{
		...
		for (auto& hmodule : hmodules) hmodule = nullptr;
